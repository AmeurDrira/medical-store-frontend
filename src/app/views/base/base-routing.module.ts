...
import { CirurgiaComponent } from './cirurgia/cirurgia.component';
import { DentisteriaComponent } from './dentisteria/dentisteria.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'dentisteria',
        component: DentisteriaComponent,
        data: {
          title: 'Dentisteria',
        },
      },
